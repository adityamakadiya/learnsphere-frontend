...
const GoogleLoginButton = ({ onError }) => {
  ...
  const handleError = () => {
    console.error("GoogleLoginButton: Google OAuth error");
      ...
      <GoogleLogin
        ...
        render={(renderProps) => (
          <button
            ...
            className="bg-white border border-gray-300 text-gray-700 py-2 px-4 rounded-lg font-semibold hover:bg-gray-50 transition flex items-center justify-center w-full"
          >
